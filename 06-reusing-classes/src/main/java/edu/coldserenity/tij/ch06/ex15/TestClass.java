package edu.coldserenity.tij.ch06.ex15;

import edu.coldserenity.tij.ch06.ex15.somepackage.AClass;
...
public class TestClass {
    public static void main(String[] args) {
        ...
        System.out.println(
                ...
                "\nwill produce \n" +
                "   Error:(27, 15) java: protectedMethod() has protected access in AClass" +
